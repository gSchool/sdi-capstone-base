...
function LoginPage() {
    ...
    function findFormErrors() {
        let { firstName, lastName, eMail, unit, position, phoneNumber, username, password } = form
        ...
        if (!position || position === '') newErrors.position = 'This is a required field.'
        if (!phoneNumber || phoneNumber === '') newErrors.phoneNumber = 'This is a required field.'
        else if ((!phoneNumber.match(validPhone))) newErrors.phoneNumber = 'Please provide a valid phone number, utilizing the proper format.'
    ...
    return (
        <div className="loginPage">
            ...
            {showAlert &&
                <>
                    <br></br>
                    <Alert className="text-center" variant="danger" onClose={() => setShowAlert(false)} dismissible>
                        <Alert.Heading>We could not find an account matching that username and password.</Alert.Heading>
                        <p>
                            Please try again, or create an account by pressing the button below.
                        </p>
                    </Alert>
                </>
            }
            ...
            {(!show && !showAlert) && <div className="stupidOR"><p>or</p></div>}
            <Button onClick={() => { setShowAlert(false); setShow(!show); setShowSuccess(false) }}>
            ...
            {show &&
                <div>
                    <Form noValidate validated={validated} className="login" onSubmit={submitUser}>
                        <Row className="mb-3">
                            <Form.Group as={Col} controlId="formGridFname">
                                <Form.Label>First Name</Form.Label>
                                <Form.Control isInvalid={!!errors.firstName} type="text" placeholder="John" onChange={e => setField('firstName', e.target.value)} />
                            ...
                            <Form.Group as={Col} controlId="formGridLname">
                                ...
                                <Form.Control isInvalid={!!errors.lastName} type="text" placeholder="Doe" onChange={e => setField('lastName', e.target.value)} />
                                <Form.Control.Feedback type="invalid">
                                    {errors.lastName}
                                </Form.Control.Feedback>
                            </Form.Group>
                            <Form.Group as={Col} controlId="formGridEmail">
                                ...
                                <Form.Control isInvalid={!!errors.eMail} type="email" placeholder="JohnDoe@army.mil" onChange={e => setField('eMail', e.target.value)} />
                                <Form.Control.Feedback type="invalid">
                                    {errors.eMail}
                                </Form.Control.Feedback>
                            </Form.Group>
                        ...
                        <Row className="mb-3">
                            <Form.Group as={Col} controlId="formGridUnit">
                                ...
                                <Form.Control isInvalid={!!errors.unit} type="text" placeholder="82nd ESB" onChange={e => setField('unit', e.target.value)} />
                                <Form.Control.Feedback type="invalid">
                                    {errors.unit}
                                </Form.Control.Feedback>
                            </Form.Group>
                            <Form.Group as={Col} controlId="formGridPosition">
                                ...
                                <Form.Control isInvalid={!!errors.position} type="text" placeholder="Team Sergeant" onChange={e => setField('position', e.target.value)} />
                                <Form.Control.Feedback type="invalid">
                                    {errors.position}
                                </Form.Control.Feedback>
                            </Form.Group>
                            <Form.Group as={Col} controlId="formGridPhone">
                                ...
                                <Form.Control isInvalid={!!errors.phoneNumber} type="text" placeholder="123-456-7890" onChange={e => setField('phoneNumber', e.target.value)} />
                                <Form.Control.Feedback type="invalid">
                                    {errors.phoneNumber}
                                </Form.Control.Feedback>
                            </Form.Group>
                        ...
                        <Row className="mb-3">
                            <Form.Group as={Col} controlId="formGridUsername">
                                <Form.Label>Username</Form.Label>
                                <Form.Control isInvalid={!!errors.username} type="text" placeholder="JohnD123" onChange={e => setField('username', e.target.value)} />
                                <Form.Control.Feedback type="invalid">
                                    {errors.username}
                                </Form.Control.Feedback>
                            </Form.Group>
                            <Form.Group as={Col} controlId="formGridPassword">
                                <Form.Label>Password</Form.Label>
                                <Form.Control isInvalid={!!errors.password} type="password" placeholder="Abc123!!" onChange={e => setField('password', e.target.value)} />
                                <Form.Control.Feedback type="invalid">
                                    {errors.password}
                                </Form.Control.Feedback>
                            </Form.Group>
                    ...
                    {showSuccess &&
                        <Alert variant="success">
                            ...
                            <p>
                                Click the button below to login with your new username and password.
                            </p>
                            <hr />
                            <div>
